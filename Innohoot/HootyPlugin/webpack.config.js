...
const clientEntrypoints = [
  {
    name: 'HOOTY - Sidebar Quiz Creation Page',
    entry: './src/client/quiz-creation-page/index.js',
    filename: 'quiz-creation-page',
    template: './src/client/quiz-creation-page/index.html',
  },
];
